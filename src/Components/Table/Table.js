                        ...
                        return <>
                            <div className='container mt-3'>
                                <div style={{display:"flex",justifyContent:"space-between"}}><h4 style={{marginTop:"20px"}}>Q. {data.question}</h4><p style={{fontWeight:"bold",marginTop:"20px"}}>1 Marks</p></div>
                                 {
                                    data.type === "radio" ? <>  <div className='div first' style={{ display: "flex", flexDirection: "row" }}><input type='radio' name='radiobutton' /> 
                                    ...
                                    <div className='div four' style={{ display: "flex", flexDirection: "row" }}><input type='radio' name='radiobutton' />
                                     ...
                                     <> <div className='div first' style={{ display: "flex", flexDirection: "row" }}><input type='checkbox' name='checkboxbutton' /> 
                                <p style={{ marginLeft: "10px", marginTop:"15px" }}>A. {data.first}</p></div>
        
                                <div className='div second' style={{ display: "flex", flexDirection: "row" }}><input type='checkbox' name='checkboxbutton' /> 
                                <p style={{ marginLeft: "10px", marginTop:"15px" }}>B. {data.second}</p></div>
        
                                <div className='div third' style={{ display: "flex", flexDirection: "row" }}><input type='checkbox' name='checkboxbutton' />
                                 <p style={{ marginLeft: "10px", marginTop:"15px" }}>C. {data.third}</p></div>
                                 
                                <div className='div four' style={{ display: "flex", flexDirection: "row" }}><input type='checkbox' name='checkboxbutton' />
